...
void initialize_mpi_and_data(int argc, char **argv, int *rank, int *size, int * group, MPI_Comm *low_comm, MPI_Comm *high_comm, int *group_rank, int *group_size, double **mat_data, double **vec_x_data, double **vec_y_data, double **sub_mat, double **sub_x_vec, double **sub_y_vec, int *rows_per_proc, int *elements_per_proc);
...
void initialize_vectors(int group, int group_rank, MPI_Comm low_comm, MPI_Comm high_comm, int elements_per_proc, double **vec_x_data, double **vec_y_data, double **sub_x_vec, double **sub_y_vec);
